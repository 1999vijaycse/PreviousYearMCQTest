...
import static mypackage.TestSWE2017.con;
import static mypackage.TestSWE2017.psmt;
import static mypackage.TestSWE2017.rs;

public class TestSWE2017 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.isNew() || session.getAttribute("uname") == null) {
            ...
            try {
                ...
                psmt = con.prepareStatement("SELECT * FROM mcq where sub='SWE' and year='2017'");
                ...
                out.print(
                        ...
                        + "<body  style=\"background:radial-gradient(#958548, #7de7a7)\">"
                        + "<center>"
                        + "<div style=color:blue><h1>Hi,&nbsp;&nbsp;" + session.getAttribute("uname") + "<br>Your Test Result<br>of<br>S/W Engg 2017 Objectives<br></h1> </div>"
                        ...
                        + "<div><h3><br><hr></h3></div>"
                        + "<div style=color:yellow><h1>***Test Summary***<br>of<br>***S/W Engg 2017***</h1></div>"
                        + "<table border=2>"
                        + "<tr>"

...
import static mypackage.TestIEA2018.con;
import static mypackage.TestIEA2018.psmt;
import static mypackage.TestIEA2018.rs;

public class TestIEA2018 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.isNew() || session.getAttribute("uname") == null) {
            ...
            try {
                ...
                psmt = con.prepareStatement("SELECT * FROM mcq where sub='IEA' and year='2018'");
                ...
                out.print(
                        ...
                        + "</a></div>" + "</div>" + "</div>"
                        + "<center>"
                        + "<div style=color:blue><h1>Hi,&nbsp;&nbsp;" + session.getAttribute("uname") + "<br>Your Test Result<br>of<br>IEA 2018 Objectives<br></h1> </div>"
                        ...
                        + "<div><h3><br><hr></h3></div>"
                        + "<div style=color:yellow><h1>***Test Summary***<br>of<br>***IEA 2018***</h1></div>"
                        + "<table border=2>"
                        + "<tr>"

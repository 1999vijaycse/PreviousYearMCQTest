...
import static mypackage.TestFLAT2017.con;
import static mypackage.TestFLAT2017.psmt;
import static mypackage.TestFLAT2017.rs;

public class TestFLAT2017 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.isNew() || session.getAttribute("uname") == null) {
            ...
            try {
                ...
                psmt = con.prepareStatement("SELECT * FROM mcq where sub='FLAT' and year='2017'");
                ...
                out.print(
                        ...
                        + "<div><h3><br><hr></h3></div>"
                        + "<div style=color:yellow><h1>***Test Summary***<br>of<br>***FLAT 2017***</h1></div>"
                        + "<table border=2>"
                        + "<tr>"

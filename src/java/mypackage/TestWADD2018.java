...
import static mypackage.TestWADD2018.con;
import static mypackage.TestWADD2018.psmt;
import static mypackage.TestWADD2018.rs;

public class TestWADD2018 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.isNew() || session.getAttribute("uname") == null) {
            ...
            try {
                ...
                psmt = con.prepareStatement("SELECT * FROM mcq where sub='WADD' and year='2018'");
                ...
                out.print(
                        ...
                        + "</a></div>" + "</div>" + "</div>"
                        + "<center>"
                        + "<div style=color:blue><h1>Hi,&nbsp;&nbsp;" + session.getAttribute("uname") + "<br>Your Test Result<br>of<br>WADD 2018 Objectives<br></h1> </div>"
                        ...
                        + "<div><h3><br><hr></h3></div>"
                        + "<div style=color:yellow><h1>***Test Summary***<br>of<br>***WADD 2018***</h1></div>"
                        + "<table border=2>"
                        + "<tr>"

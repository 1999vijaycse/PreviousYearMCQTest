...
import static mypackage.TestIEA2016.con;
import static mypackage.TestIEA2016.psmt;
import static mypackage.TestIEA2016.rs;

public class TestIEA2016 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.isNew() || session.getAttribute("uname") == null) {
            ...
            try {
                ...
                psmt = con.prepareStatement("SELECT * FROM mcq where sub='IEA' and year='2016'");
                ...
                out.print(
                        ...
                        + "</a></div>" + "</div>" + "</div>"
                        + "<center>"
                        + "<div style=color:blue><h1>Hi,&nbsp;&nbsp;" + session.getAttribute("uname") + "<br>Your Test Result<br>of<br>IEA 2016 Objectives<br></h1> </div>"
                        ...
                        + "<div><h3><br><hr></h3></div>"
                        + "<div style=color:yellow><h1>***Test Summary***<br>of<br>***IEA 2016***</h1></div>"
                        + "<table border=2>"
                        + "<tr>"
